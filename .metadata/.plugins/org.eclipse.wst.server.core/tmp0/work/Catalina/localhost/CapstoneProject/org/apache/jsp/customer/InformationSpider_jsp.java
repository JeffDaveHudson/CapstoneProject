 ...
 * Generated at: 2023-04-27 08:15:25 UTC
...
public final class InformationSpider_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final jakarta.servlet.http.HttpServletRequest request, final jakarta.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("				<img src=\"https://res.cloudinary.com/dedbfm0dk/image/upload/v1681730552/capstoneproject/pest/nhen_eysnxi.jpg\">\r\n");
      out.write("			</div>\r\n");
      out.write("			<div class=\"info\">\r\n");
      out.write("				<div class=\"info-title\">\r\n");
      out.write("					<h1>NHỆN</h1>\r\n");
      out.write("					<h5>(Tên khoa học: Araneae)</h5>\r\n");
      out.write("					<p> <span>Đặc điểm:</span> Phần lớn các loài côn trùng thân mình có ba phần: đầu, ngực và bụng. \r\n");
      out.write("					Nhện khác biệt ở chỗ chỉ có hai phần: đầu-ngực vào một phần, phần kia là bụng. Bên ngoài phần bụng \r\n");
      out.write("					của nhện không ngăn ra nhiều đoạn. Nhện thường xuất hiện ở trần nhà, trên cây hay những góc tối. \r\n");
      out.write("					Chúng thường giăng tơ để bắt mồi.</p>\r\n");
      out.write("				</div>\r\n");
      out.write("			</div>\r\n");
      out.write("		</div>\r\n");
      out.write("	</section>\r\n");
      ...
      out.write("				<p> Vòng đời nhện gồm 4 giai đoạn. Con cái đẻ khoảng 250 trứng/ lần và giấu vào những kén tơ. \r\n");
      out.write("				Những kén trứng này thường có màu nâu và trông như túi đựng súng. Những con cái có thể đẻ lên đến \r\n");
      out.write("				17 túi trứng/ vòng đời, khoảng hơn 4000 trứng.</p>\r\n");
      out.write("			</div>\r\n");
      out.write("			<div class=\"img\">\r\n");
      out.write("				<img src=\"https://res.cloudinary.com/dedbfm0dk/image/upload/v1681983220/capstoneproject/pest/lifecycle/spiderlifecycle_zbpr5n.png\">\r\n");
      out.write("			</div>\r\n");
      out.write("		</div>\r\n");
      out.write("	</section>\r\n");
      out.write("	\r\n");
      ...
      out.write("				<img src=\"https://res.cloudinary.com/dedbfm0dk/image/upload/v1681983460/capstoneproject/pest/fact/spider_sqd2up.jpg\">\r\n");
      out.write("			</div>\r\n");
      out.write("			<div class=\"info\">\r\n");
      out.write("				<div class=\"info-title\">\r\n");
      out.write("					<h1>FACT</h1>\r\n");
      out.write("					<h2>Môi Trường Sống</h2>\r\n");
      out.write("					<p>Một số loài nhện thích độ ẩm và được tìm thấy trong các tầng hầm, không gian thu thập thông tin \r\n");
      out.write("					và các bộ phận ẩm ướt khác của các tòa nhà.</p>\r\n");
      out.write("					<h2>Thức Ăn</h2>\r\n");
      out.write("					<p>Chúng ăn côn trùng, nhện khác và bất kỳ con mồi nào khác mà chúng có thể khuất phục.</p>\r\n");
      out.write("					<h2>Tơ Nhện</h2>\r\n");
      out.write("					<p>Con cái tạo ra một túi trứng nở ra nhện con. Nhện con trải qua một loạt lần lột xác và cuối cùng trở thành người lớn. \r\n");
      out.write("					Con đực của nhiều loài nhện vây lấy con cái.</p>\r\n");
      out.write("				</div>\r\n");
      out.write("			</div>\r\n");
      out.write("		</div>\r\n");
      out.write("	</section>\r\n");
      ...
      out.write("				<h2><span>BẠN CẦN XỬ LÝ </span><br/>ĐÁM NHỆN ĐÓ?<br/> HÃY LIÊN HỆ CHÚNG TÔI</h2>\r\n");
