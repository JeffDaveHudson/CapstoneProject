 ...
 * Generated at: 2023-04-27 08:15:08 UTC
...
public final class InformationMosquito_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final jakarta.servlet.http.HttpServletRequest request, final jakarta.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("				<img src=\"https://res.cloudinary.com/dedbfm0dk/image/upload/v1681730552/capstoneproject/pest/muoi_jbi12x.png\">\r\n");
      out.write("			</div>\r\n");
      out.write("			<div class=\"info\">\r\n");
      out.write("				<div class=\"info-title\">\r\n");
      out.write("					<h1>MUỖI</h1>\r\n");
      out.write("					<h5>(Tên khoa học: Culicidae)</h5>\r\n");
      out.write("					<p> <span>Đặc điểm:</span> Muỗi là loài côn trùng có cánh với cơ thể đạt trọng lượng khoảng 2,5mg \r\n");
      out.write("					và tốc độ bay đạt đến 2,5km/h. Nhờ sự kết hợp sinh học giữa muỗi đực và muỗi cái, mỗi cá thể \r\n");
      out.write("					muỗi cái có thể sản sinh ra từ 100 đến 200 trứng mỗi chu kỳ sinh sản. Muỗi cái đảm nhận nhiệm vụ \r\n");
      out.write("					sinh sản. Chính do đặc tính này, muỗi đực chỉ cần hút nhựa cây và hoa quả để sống, trong khi muỗi cái \r\n");
      out.write("					cần hút máu người và động vật để đảm bảo đủ protein cho quá trình sinh sản.</p>\r\n");
      out.write("				</div>\r\n");
      out.write("			</div>\r\n");
      out.write("		</div>\r\n");
      out.write("	</section>\r\n");
      ...
      out.write("				<p> Quá trình phát triển thành cá thể trưởng thành từ trứng của muỗi đực có thể diễn ra trong vòng 20 ngày, \r\n");
      out.write("				trong khi muỗi cái lên đến 2 tháng. Trong khi đó, độ dài vòng đời của muỗi tùy thuộc vào môi trường sinh sống \r\n");
      out.write("				của chúng như nhiệt độ, lượng thức ăn,...</p>\r\n");
      out.write("			</div>\r\n");
      out.write("			<div class=\"img\">\r\n");
      out.write("				<img src=\"https://res.cloudinary.com/dedbfm0dk/image/upload/v1681981607/capstoneproject/pest/lifecycle/mosquitolifecycle_izgqql.png\">\r\n");
      out.write("			</div>\r\n");
      out.write("		</div>\r\n");
      out.write("	</section>\r\n");
      out.write("	\r\n");
      ...
      out.write("				<img src=\"https://res.cloudinary.com/dedbfm0dk/image/upload/v1681981846/capstoneproject/pest/fact/mosquitofact_llcsnq.jpg\">\r\n");
      out.write("			</div>\r\n");
      out.write("			<div class=\"info\">\r\n");
      out.write("				<div class=\"info-title\">\r\n");
      out.write("					<h1>FACT</h1>\r\n");
      out.write("					<h2>Tuổi Thọ</h2>\r\n");
      out.write("					<p>Nói chung, muỗi đực nhỏ hơn muỗi cái cùng loài và sống ngắn hơn muỗi cái.</p>\r\n");
      out.write("					<h2>Bệnh Tật</h2>\r\n");
      out.write("					<p>Viêm não do muỗi lây lan tiếp tục là một vấn đề nhức nhối.</p>\r\n");
      out.write("					<h2>Thức Ăn</h2>\r\n");
      out.write("					<p>Muỗi trưởng thành đực không hút máu, trong khi muỗi cái hút máu để đẻ trứng. \r\n");
      out.write("					Một số loài con cái trưởng thành hoàn toàn không ăn máu và duy trì chế độ ăn gồm \r\n");
      out.write("					mật hoa thực vật và các loại đường khác, giống như con đực.</p>\r\n");
      out.write("					<h2>Vòi Muỗi</h2>\r\n");
      out.write("					<p>Vòi của muỗi cái kéo dài ra khỏi vùng miệng tương đối nhẵn trong khi muỗi đực trưởng thành hơi rậm rạp.\r\n");
      out.write("					</p>\r\n");
      out.write("				</div>\r\n");
      out.write("			</div>\r\n");
      out.write("		</div>\r\n");
      ...
      out.write("				<h2><span>BẠN CẦN XỬ LÝ </span><br/>ĐÁM MUỖI ĐÓ?<br/> HÃY LIÊN HỆ CHÚNG TÔI</h2>\r\n");
