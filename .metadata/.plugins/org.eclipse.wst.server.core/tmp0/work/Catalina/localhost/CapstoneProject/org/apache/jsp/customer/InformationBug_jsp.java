 ...
 * Generated at: 2023-04-27 08:15:47 UTC
...
public final class InformationBug_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final jakarta.servlet.http.HttpServletRequest request, final jakarta.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("				<img src=\"https://res.cloudinary.com/dedbfm0dk/image/upload/v1681732232/capstoneproject/pest/rep_ycqajr.png\">\r\n");
      out.write("			</div>\r\n");
      out.write("			<div class=\"info\">\r\n");
      out.write("				<div class=\"info-title\">\r\n");
      out.write("					<h1>RỆP</h1>\r\n");
      out.write("					<h5>(Tên khoa học: Hemiptera)</h5>\r\n");
      out.write("					<p> <span>Đặc điểm:</span> Rệp là loài côn trùng nhỏ cánh nửa cứng, kích thích thước nhỏ khi chiều dài trưởng thành \r\n");
      out.write("					trung bình chỉ đạt 5mm. Rệp thường có màu đỏ sẫm hoặc đỏ tươi nếu chúng hút đầy máu vào khoang bụng, thế nhưng với \r\n");
      out.write("					kích thước rất nhỏ, rệp rất khó được quan sát thấy bằng mắt thường.</p>\r\n");
      out.write("				</div>\r\n");
      out.write("			</div>\r\n");
      out.write("		</div>\r\n");
      out.write("	</section>\r\n");
      ...
      out.write("				<p> Vòng đời của rệp thường kéo dài từ 4-5 tháng, Rệp cái đảm nhiệm vai trò sinh sản với \"năng suất\" từ 1-5 \r\n");
      out.write("				trứng mỗi ngày và lên đến 500 trứng suốt vòng đời. Trứng rệp dài khoảng 1mm và rệp con có thể hút máu ngay sau khi nở từ trứng.</p>\r\n");
      out.write("			</div>\r\n");
      out.write("			<div class=\"img\">\r\n");
      out.write("				<img src=\"https://res.cloudinary.com/dedbfm0dk/image/upload/v1681989004/capstoneproject/pest/lifecycle/buglifecycle_zdjj6y.png\">\r\n");
      out.write("			</div>\r\n");
      out.write("		</div>\r\n");
      out.write("	</section>\r\n");
      out.write("	\r\n");
      ...
      out.write("				<img src=\"https://res.cloudinary.com/dedbfm0dk/image/upload/v1681988930/capstoneproject/pest/fact/bugfact_umq6si.jpg\">\r\n");
      out.write("			</div>\r\n");
      out.write("			<div class=\"info\">\r\n");
      out.write("				<div class=\"info-title\">\r\n");
      out.write("					<h1>FACT</h1>\r\n");
      out.write("					<h2>Lịch Sử</h2>\r\n");
      out.write("					<p> Ở châu Âu, rệp xuất hiện vào thời trung cổ: Đức - thế kỷ XI; Anh - thế kỷ XIII. \r\n");
      out.write("					Chúng đến Mỹ với những người định cư vào thế kỷ 16 và được ghi nhận ở Trung Á vào thế kỷ XIX.</p>\r\n");
      out.write("					<h2>Thời Gian Hoạt Động</h2>\r\n");
      out.write("					<p>Rệp là động vật chân đốt hoạt động vào ban đêm, cao điểm lúc 3-8 giờ nhưng cá thể đói cắn vào buổi chiều.</p>\r\n");
      out.write("					<h2>Sinh Sản</h2>\r\n");
      out.write("					<p>Con bọ cái chỉ cần một lần thụ tinh để đẻ trứng trong suốt cuộc đời. Khả năng sinh sản của nó là 250-500 trứng.</p>\r\n");
      out.write("				</div>\r\n");
      out.write("			</div>\r\n");
      out.write("		</div>\r\n");
      out.write("	</section>\r\n");
      ...
      out.write("				<h2><span>BẠN CẦN XỬ LÝ </span><br/>ĐÁM RỆP ĐÓ?<br/> HÃY LIÊN HỆ CHÚNG TÔI</h2>\r\n");
