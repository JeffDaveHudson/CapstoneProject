 ...
 * Generated at: 2023-04-27 08:15:29 UTC
...
public final class InformationSnake_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final jakarta.servlet.http.HttpServletRequest request, final jakarta.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("				<img src=\"https://res.cloudinary.com/dedbfm0dk/image/upload/v1681732232/capstoneproject/pest/ran_qj8lp1.jpg\">\r\n");
      out.write("			</div>\r\n");
      out.write("			<div class=\"info\">\r\n");
      out.write("				<div class=\"info-title\">\r\n");
      out.write("					<h1>RẮN</h1>\r\n");
      out.write("					<h5>(Tên khoa học: Serpentes)</h5>\r\n");
      out.write("					<p> <span>Đặc điểm:</span> Rắn là loài động vật máu lạnh và bò sát ăn thịt, chúng không chân mà chỉ có thân người, \r\n");
      out.write("					chúng di chuyển bằng việc trườn ở trên mặt đất. Chính vì chúng chỉ trườn nên di chuyển sẽ ít gây tiếng động và \r\n");
      out.write("					săn mồi tốt hơn. Chúng có một đặc điểm cấu tạo sau: không có tai ngoài, không mí mắt, có xương sống, không có lông. \r\n");
      out.write("					Ngoài ra phần quai hàm với cấu tạo vô cùng đặc biệt có thể khiến chúng nuốt chửng con mồi khá to so với người của chúng.</p>\r\n");
      out.write("				</div>\r\n");
      out.write("			</div>\r\n");
      out.write("		</div>\r\n");
      out.write("	</section>\r\n");
      ...
      out.write("				<p> 70% rắn bắt đầu cuộc sống của chúng phát triển bên trong trứng, trong khi 30% còn lại được sinh ra sống. \r\n");
      out.write("				Một số con mẹ rời đi, số khác ở lại với trứng của chúng cho đến khi chúng nở. Quá trình này \r\n");
      out.write("				được gọi là ấp trứng. Rắn con đã hình thành hoàn chỉnh nhanh chóng di chuyển để tránh trở thành bữa tối. \r\n");
      out.write("				Rắn con nhanh chóng học cách săn mồi. Khi chúng lớn lên, chúng sẽ rụng da. \r\n");
      out.write("				Con rắn non lớn lên và trở thành một con trưởng thành có khả năng sinh sản và bắt đầu lại vòng đời.</p>\r\n");
      out.write("			</div>\r\n");
      out.write("			<div class=\"img\">\r\n");
      out.write("				<img src=\"https://res.cloudinary.com/dedbfm0dk/image/upload/v1681982133/capstoneproject/pest/lifecycle/snakelifecycle_k9qkmf.png\">\r\n");
      out.write("			</div>\r\n");
      out.write("		</div>\r\n");
      out.write("	</section>\r\n");
      out.write("	\r\n");
      ...
      out.write("				<img src=\"https://res.cloudinary.com/dedbfm0dk/image/upload/v1681982534/capstoneproject/pest/fact/snakefact_xs0odh.jpg\">\r\n");
      out.write("			</div>\r\n");
      out.write("			<div class=\"info\">\r\n");
      out.write("				<div class=\"info-title\">\r\n");
      out.write("					<h1>FACT</h1>\r\n");
      out.write("					<h2>Tập Tính</h2>\r\n");
      out.write("					<p>Hầu hết các loài rắn là sinh vật nhút nhát và chúng có xu hướng tránh tiếp xúc với con người. \r\n");
      out.write("					Chúng chỉ tấn công nếu bị dồn vào góc hay bị khiêu khích, trong đa số trường hợp, chúng tấn công để tự vệ.</p>\r\n");
      out.write("					<h2>Nọc Rắn</h2>\r\n");
      out.write("					<p>Sự nguy hiểm do bị rắn cắn và tính độc hại của nọc rắn chích vào nạn nhân có mức độ khác nhau tùy theo loài rắn.</p>\r\n");
      out.write("					<h2>Lột Da</h2>\r\n");
      out.write("					<p>Xác lột - rắn lột xác khoảng 6 lần một năm. Quá trình này gọi là thay da. Dấu vết - có thể thấy trên bụi mờ \r\n");
      out.write("					hay bề mặt có cát, nhất là qua các khu vực đất trống hẻo lánh.</p>\r\n");
      out.write("				</div>\r\n");
      out.write("			</div>\r\n");
      out.write("		</div>\r\n");
      out.write("	</section>\r\n");
      ...
      out.write("				<h2><span>BẠN CẦN XỬ LÝ </span><br/>ĐÁM RẮN ĐÓ?<br/> HÃY LIÊN HỆ CHÚNG TÔI</h2>\r\n");
