 ...
 * Generated at: 2023-04-27 08:15:17 UTC
...
public final class InformationDragonfly_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final jakarta.servlet.http.HttpServletRequest request, final jakarta.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("				<img src=\"https://res.cloudinary.com/dedbfm0dk/image/upload/v1681731159/capstoneproject/pest/chuonchuon_uy54qe.jpg\">\r\n");
      out.write("			</div>\r\n");
      out.write("			<div class=\"info\">\r\n");
      out.write("				<div class=\"info-title\">\r\n");
      out.write("					<h1>CHUỒN CHUỒN</h1>\r\n");
      out.write("					<h5>(Tên khoa học: Odonata)</h5>\r\n");
      out.write("					<p> <span>Đặc điểm:</span> Chuồn chuồn dài khoảng 5-10cm. Các chi thả lỏng xuống dưới. Trên lưng có 4 cánh.\r\n");
      out.write("					Chuồn chuồn có hình dạng như một chiếc máy bay trực thăng, với hai đôi cánh không bao giờ gập kể cả khi chúng đang nghỉ ngơi.</p>\r\n");
      out.write("				</div>\r\n");
      out.write("			</div>\r\n");
      out.write("		</div>\r\n");
      out.write("	</section>\r\n");
      ...
      out.write("				<p> Ba giai đoạn: trứng, ấu trùng và chuồn chuồn trưởng thành. \r\n");
      out.write("				Trứng sau khi giao phối, chuồn chuồn cái tìm các lá cây an toàn để đẻ trứng. Nếu không tìm được, nó sẽ đẻ trứng lên cả mặt nước. \r\n");
      out.write("				Ấu trùng chiếm 2/3 quãng đời của chuồn chuồn, là giai đoạn lâu nhất trong vòng đời của nó. Trưởng thành khi thời tiết trở nên \r\n");
      out.write("				ấm áp hoặc vào cuối giai đoạn ấu trùng, chúng bò lên khỏi mặt nước và dán mình chặt vào thân cây và bắt đầu quá trình lột xác.</p>\r\n");
      out.write("			</div>\r\n");
      out.write("			<div class=\"img\">\r\n");
      out.write("				<img src=\"https://res.cloudinary.com/dedbfm0dk/image/upload/v1682004814/capstoneproject/pest/lifecycle/dragonflylifecycle_p83egc.png\">\r\n");
      out.write("			</div>\r\n");
      out.write("		</div>\r\n");
      out.write("	</section>\r\n");
      out.write("	\r\n");
      ...
      out.write("				<img src=\"https://res.cloudinary.com/dedbfm0dk/image/upload/v1682004917/capstoneproject/pest/fact/dragonflyfact_yvwza7.jpg\">\r\n");
      out.write("			</div>\r\n");
      out.write("			<div class=\"info\">\r\n");
      out.write("				<div class=\"info-title\">\r\n");
      out.write("					<h1>FACT</h1>\r\n");
      out.write("					<h2>Đôi Cánh</h2>\r\n");
      out.write("					<p> Chuồn chuồn có đôi cánh không bao giờ khép lại.</p>\r\n");
      out.write("					<h2>Cảnh Báo</h2>\r\n");
      out.write("					<p> Chuồn chuồn sử dụng màu sắc của cơ thể như một dấu hiệu cảnh bảo các loài vật khác.</p>\r\n");
      out.write("					<h2>Vòng Đời</h2>\r\n");
      out.write("					<p> Chuồn chuồn dành phần lớn thời gian cuộc đời ở giai đoạn ấu trùng và sống dưới nước.</p>\r\n");
      out.write("				</div>\r\n");
      out.write("			</div>\r\n");
      out.write("		</div>\r\n");
      out.write("	</section>\r\n");
      ...
      out.write("				<h2><span>BẠN CẦN XỬ LÝ </span><br/>ĐÁM CHUỒN CHUỒN ĐÓ?<br/> HÃY LIÊN HỆ CHÚNG TÔI</h2>\r\n");
