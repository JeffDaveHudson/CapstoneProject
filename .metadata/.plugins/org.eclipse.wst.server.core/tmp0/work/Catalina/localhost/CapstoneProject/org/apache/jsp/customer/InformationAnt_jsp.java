 ...
 * Generated at: 2023-04-27 08:15:02 UTC
...
public final class InformationAnt_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final jakarta.servlet.http.HttpServletRequest request, final jakarta.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("				<img src=\"https://res.cloudinary.com/dedbfm0dk/image/upload/v1681730552/capstoneproject/pest/kien_y7jees.jpg\">\r\n");
      out.write("			</div>\r\n");
      out.write("			<div class=\"info\">\r\n");
      out.write("				<div class=\"info-title\">\r\n");
      out.write("					<h1>KIẾN</h1>\r\n");
      out.write("					<h5>(Tên khoa học: Formicidae)</h5>\r\n");
      out.write("					<p> <span>Đặc điểm</span> kiến có thể có màu đen, nâu hoặc hơi đỏ, và có kích thước từ 0,75 đến 52 milimét. \r\n");
      out.write("					Một tổ kiến thường có 100.000 cá thể và bao gồm ba loại: Kiến chúa, kiến thợ và kiến đực. Kiến chúa là \r\n");
      out.write("					cá thể cái duy nhất có khả năng sinh sản trong tổ kiến. Toàn bộ kiến thợ là giống cái và chiếm số lượng \r\n");
      out.write("					lớn nhất trong tổ kiến với chức năng xây tổ, kiếm thức ăn, nuôi dưỡng ấu trùng, bảo vệ tổ kiến. Khi \r\n");
      out.write("					kiến chúa chết, một trong số kiến thợ sẽ được chọn để trở thành kiến chúa. Kiến đực là những cá thể \r\n");
      out.write("					có cánh trong đàn, chúng có nhiệm vụ duy nhất là giao phối với kiến chúa để tạo ra thế hệ mới.</p>\r\n");
      out.write("				</div>\r\n");
      out.write("			</div>\r\n");
      out.write("		</div>\r\n");
      out.write("	</section>\r\n");
      ...
      out.write("				<p> Quá trình phát triển của Kiến có thể diễn ra trong vòng 4 - 8 tuần, \r\n");
      out.write("				tùy thuộc vào môi trường sinh sống của chúng như nhiệt độ, lượng thức ăn,...</p>\r\n");
      out.write("			</div>\r\n");
      out.write("			<div class=\"img\">\r\n");
      out.write("				<img src=\"https://res.cloudinary.com/dedbfm0dk/image/upload/v1681978670/capstoneproject/pest/lifecycle/antlifecycle_kddfvj.png\">\r\n");
      out.write("			</div>\r\n");
      out.write("		</div>\r\n");
      out.write("	</section>\r\n");
      out.write("	\r\n");
      ...
      out.write("				<img src=\"https://res.cloudinary.com/dedbfm0dk/image/upload/v1681979000/capstoneproject/pest/fact/antfact_dfxwmb.jpg\">\r\n");
      out.write("			</div>\r\n");
      out.write("			<div class=\"info\">\r\n");
      out.write("				<div class=\"info-title\">\r\n");
      out.write("					<h1>FACT</h1>\r\n");
      out.write("					<h2>Sống Sót</h2>\r\n");
      out.write("					<p>Kiến có thể sống sót dưới nước trong vòng 24 giờ.</p>\r\n");
      out.write("					<h2>Sức Mạnh</h2>\r\n");
      out.write("					<p>Kiến có khả năng khiêng vật bằng hàm trên nặng gấp 50 lần trọng lượng của cơ thể chúng.</p>\r\n");
      out.write("					<h2>Trọng Lượng</h2>\r\n");
      out.write("					<p>Tổng trọng lượng của toàn bộ số kiến trên thế giới là bằng, nếu không muốn nói là lớn hơn dân số thế giới.</p>\r\n");
      out.write("					<h2>Tiến Hóa</h2>\r\n");
      out.write("					<p>Kiến tiến hóa từ tổ tiên của chúng giống như ong vò vẽ ở thời kỳ khủng long cách đây 110 đến 130 triệu năm.</p>\r\n");
      out.write("				</div>\r\n");
      out.write("			</div>\r\n");
      out.write("		</div>\r\n");
      out.write("	</section>\r\n");
      ...
      out.write("				<h2><span>BẠN CẦN XỬ LÝ </span><br/>ĐÁM KIẾN ĐÓ?<br/> HÃY LIÊN HỆ CHÚNG TÔI</h2>\r\n");
