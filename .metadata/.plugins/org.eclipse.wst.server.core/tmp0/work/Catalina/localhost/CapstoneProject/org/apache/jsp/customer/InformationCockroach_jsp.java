 ...
 * Generated at: 2023-04-27 08:14:59 UTC
...
public final class InformationCockroach_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final jakarta.servlet.http.HttpServletRequest request, final jakarta.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("				<img src=\"https://res.cloudinary.com/dedbfm0dk/image/upload/v1681730552/capstoneproject/pest/gian_jqs058.jpg\">\r\n");
      out.write("			</div>\r\n");
      out.write("			<div class=\"info\">\r\n");
      out.write("				<div class=\"info-title\">\r\n");
      out.write("					<h1>GIÁN</h1>\r\n");
      out.write("					<h5>(Tên khoa học: Blattodea)</h5>\r\n");
      out.write("					<p> <span>Đặc điểm:</span> Gián là loài côn trùng có kích thước từ 3-80mm, toàn thân phủ màu nâu sáng hoặc đen. \r\n");
      out.write("					Gián có tập tính ăn uống không đều, trong khi gián đực giành phần lớn thời gian đi kiếm ăn thì gián cái chỉ \r\n");
      out.write("					ở yên một chỗ mà không cần ăn uống gì. Gián cái thường sản sinh 30-40 trứng mỗi 2-3 tuần, mỗi năm có thể có \r\n");
      out.write("					từ 2 đến 3 mùa sinh sản.</p>\r\n");
      out.write("				</div>\r\n");
      out.write("			</div>\r\n");
      out.write("		</div>\r\n");
      out.write("	</section>\r\n");
      ...
      out.write("					<p>Gián thuộc bộ nhóm sinh vật đa bào nhân chuẩn. Một số loài xâm nhập nơi ở của con người và được coi là loài gây hại.</p>\r\n");
      ...
      out.write("					<h2>Tác Động Đến Môi Trường</h2>\r\n");
      out.write("					<p>Một số loài gián có lợi cho môi trường là những người tái chế quan trọng các chất hữu cơ đang thối rữa.</p>\r\n");
      out.write("				</div>\r\n");
      out.write("			</div>\r\n");
      out.write("		</div>\r\n");
      out.write("	</section>\r\n");
