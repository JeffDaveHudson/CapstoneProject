...
<body>
	...
	<section class="cm-section1">
		<div class="div1">
			<div class="img">
				<img src="https://res.cloudinary.com/dedbfm0dk/image/upload/v1682486363/capstoneproject/controldetail/pest/controlsnake_ybrjjx.jpg">
			</div>
			<div class="content">
				<h1>MỐI NGUY HẠI</h1>
				<div class="dangerous1">
					<h4>Nọc Độc</h4>
					<p>Một số loài rắn có nọc độc có khả năng huỷ hoại tế bào, suy giảm chức năng tế bào, thậm chí gây suy hô hấp và ngừng thở.</p>
				</div>
				<div class="dangerous2">
					<h4>Ảnh Hưởng Cuộc Sống</h4>
					<p>Gây hoảng sợ đối với những người bắt gặp rắn, suy giảm chất lượng cuộc sống.</p>
				</div>
				<div class="dangerous3">
					<h4>Cắn Chết Động Vật</h4>
					<p>Một số loài động vật nuôi nhỏ có thể bị ăn thịt bởi rắn, hoặc có thể chết vì nọc độc của rắn.</p>
				</div>
			</div>
		</div>
	</section>
		...
		<div class="div1">
			<div class="content">
				...
				<div class="content-detail">
					<h4>* Lột Da</h4>
					<p>Da rắn có độ co giãn rất hạn chế vì vậy khi phát triển chúng sẽ bỏ lớp da cũ của mình. 
					Ta có thể phát hiện dấu hiệu của chúng qua lớp da rắn khi lột xác.</p>
					<h4>* Dấu Vết</h4>
					<p>Khi bò qua các khu đất trống, bề mặt có cát ta có thể phát hiện các đường mờ mờ rắn di chuyển</p>
				</div>
			</div>
			<div class="img">
	...
	<section class="cm-section3">
		<div class="div1">
			<div class="img">
				<img src="https://res.cloudinary.com/dedbfm0dk/image/upload/v1682484105/capstoneproject/controldetail/pest/preventfrompest/preventsnake_zpts8z.jpg">
			</div>
			<div class="content">
				<h1>NGĂN CHẶN</h1>
				<div class="content-detail">
					<img src="https://res.cloudinary.com/dedbfm0dk/image/upload/v1682416529/capstoneproject/logo/tinylogo_sq5t6z.jpg">
					<div class="detail"><p>Cắt tỉa cỏ xung quanh thường xuyên để cho chúng ngắn lại.</p></div>
				</div>
				<div class="content-detail">
					<img src="https://res.cloudinary.com/dedbfm0dk/image/upload/v1682416529/capstoneproject/logo/tinylogo_sq5t6z.jpg">
					<div class="detail"><p>Dọn dẹp, không để đống gỗ, đã và bụi bẩn xung quanh nhà bạn.</p></div>
				</div>
				<div class="content-detail">
					<img src="https://res.cloudinary.com/dedbfm0dk/image/upload/v1682416529/capstoneproject/logo/tinylogo_sq5t6z.jpg">
					<div class="detail"><p>Bịt các lỗ xung quanh nhà, dưới nhà kho nơi rắn có thể cư ngụ, xây các hàng.</p></div>
				</div>
				<div class="content-detail">
					<img src="https://res.cloudinary.com/dedbfm0dk/image/upload/v1682416529/capstoneproject/logo/tinylogo_sq5t6z.jpg">
					<div class="detail"><p>Lắp đặt hàng rào hoặc tường kín xung quanh nhà, ao để ngăn ngừa rắn xâm nhập.</p></div>
				</div>
			</div>
		</div>
	</section>
