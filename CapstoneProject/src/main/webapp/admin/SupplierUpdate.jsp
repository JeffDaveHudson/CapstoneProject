...
<body>
	...
	<section class="home">
		<div class="text">Supplier Updating Page</div>
		<h2 class="banner ">Supplier Updating</h2>
		<form:form modelAttribute="supplierupdate" class="searchform"
			action="processupdatesupplier" method="post">
						...
						<c:forEach items="${supplierList}" var="supplierlist">
							<tr>
								<td><form:input type="text" path="id"
										value="${supplierlist.id}" readonly="true" /></td>
								<td><form:input type="text" path="supplierName"
										value="${supplierlist.supplierName}" /></td>
								...
								<td><select name="supplierTypeClicked">
										<c:forEach items="${supplierTypeList}" var="suppliertypelist">
											<c:if
												...
												<option value="${suppliertypelist.id}" selected>${suppliertypelist.supplierType}</option>
											</c:if>
