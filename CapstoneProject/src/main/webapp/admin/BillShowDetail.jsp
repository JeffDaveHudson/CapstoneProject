...
<body>
	...
	<section class="home">
		...
		<h2 class="banner ">Chi Tiết Hóa Đơn</h2>
		...
		<div class="table-wrapper">
			<form:form modelAttribute="billDetail" action="processbillcreate"
				...
				<br>
				<a href="bill" class="button-search" style="text-decoration: none; padding: 11px 18px 11px 18px;">Quay Lại</a>
