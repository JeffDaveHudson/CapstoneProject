...
<body>
	...
	<section class="cm-section1">
		<div class="div1">
			<div class="img">
				<img src="https://res.cloudinary.com/dedbfm0dk/image/upload/v1682486364/capstoneproject/controldetail/pest/controlbee_ftmevm.jpg">
			</div>
			<div class="content">
				<h1>MỐI NGUY HẠI</h1>
				<div class="dangerous1">
					<h4>Hoảng Sợ</h4>
					<p>Gây hoảng sợ cho một số người nếu nhìn thấy chúng.</p>
				</div>
				<div class="dangerous2">
					<h4>Ảnh Hưởng Cuộc Sống</h4>
					<p>Tiếng kêu vo ve của ong gây ảnh hưởng đến giấc ngủ và làm chúng ta mất tập trung công việc, suy giảm chất lượng cuộc sống.</p>
				</div>
				<div class="dangerous3">
					<h4>Vết Cắn</h4>
					<p>Vết cắn của ong khá đau và có thể sưng và kéo dài nhiều ngày do có chứa nọc độc.</p>
				</div>
			</div>
		</div>
	</section>
		...
		<div class="div1">
			<div class="content">
				...
				<div class="content-detail">
					<h4>* Âm Thanh</h4>
					<p>Tiếng kêu vo ve phát ra từ đôi cánh là dấu hiệu dễ nhận biết nhất cho sự xâm nhập của loài ong.</p>
					<h4>* Tổ</h4>
					<p>Ong có thể làm tổ khá nhanh. Bạn sẽ không bất ngờ nếu thấy một cái tổ ong trên góc trần nhà.</p>
					<h4>* Vết Chích</h4>
					<p>Vết chích của ong gây đau nhức và sưng tấy.</p>
				</div>
			</div>
			<div class="img">
	...
	<section class="cm-section3">
		<div class="div1">
			<div class="img">
				<img src="https://res.cloudinary.com/dedbfm0dk/image/upload/v1682483592/capstoneproject/controldetail/pest/preventfrompest/preventbee_aqpv1g.jpg">
			</div>
			<div class="content">
				<h1>NGĂN CHẶN</h1>
				<div class="content-detail">
					<img src="https://res.cloudinary.com/dedbfm0dk/image/upload/v1682416529/capstoneproject/logo/tinylogo_sq5t6z.jpg">
					<div class="detail"><p>Hạn chế các mùi hương thu hút ong như hoa...</p></div>
				</div>
				<div class="content-detail">
					<img src="https://res.cloudinary.com/dedbfm0dk/image/upload/v1682416529/capstoneproject/logo/tinylogo_sq5t6z.jpg">
					<div class="detail"><p>Ngăn chặn ong vào nhà bằng cách sử dụng long não, quế, tinh dầu xả chanh...</p></div>
				</div>
				<div class="content-detail">
					<img src="https://res.cloudinary.com/dedbfm0dk/image/upload/v1682416529/capstoneproject/logo/tinylogo_sq5t6z.jpg">
					<div class="detail"><p>Lắp đặt cửa lưới chống côn trùng để ngăn không cho ong xâm nhập vào không gian sống.</p></div>
				</div>
			</div>
		</div>
	</section>
