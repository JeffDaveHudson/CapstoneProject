...
<link rel="stylesheet" type="text/css" href="resources/css/style-customer-information-detail.css">
<style type="text/css">
...
<body>
	...
	<section class="section1">
		<div class="s1-div1">
			<div class="s1-d1-img">
				<img src="https://res.cloudinary.com/dedbfm0dk/image/upload/v1681732232/capstoneproject/pest/bochet_ydbxpn.jpg">
			</div>
			<div class="info">
				<div class="info-title">
					<h1>BỌ CHÉT</h1>
					<h5>(Tên khoa học: Family Ixodidae)</h5>
					<p> <span>Đặc điểm:</span> Thân bọ chét dẹt 2 bên, cấu tạo đối xứng, vỏ thân bằng kitin dày, cứng. 
					Bọ chét dài 1- 5 mm, con đực nhỏ hơn con cái. Bọ chét có màu vàng, nâu, nâu sẫm hoặc đen... màu sắc 
					biến đổi đậm nhạt tùy theo môi trường sống. Toàn thân bọ chét có phủ nhiều lông cứng, mọc xuôi về phía sau. 
					Đầu có 2 anten, ngực có 3 đốt là đầu, giữa và sau mỗi đốt là 1 đôi chân, mỗi chân có 5 đốt, chân sau mập và dài nhất...</p>
				</div>
			</div>
		</div>
	</section>
	...
	<section class="section2">
		<div class="s2-div1">
			<div class="info">
				<h1>VÒNG ĐỜI</h1>
				<p> Vòng đời bọ chét trải qua 4 giai đoạn: trứng - ấu trùng - thanh trùng (nhộng) và trưởng thành.</p>
			</div>
			<div class="img">
				<img src="https://res.cloudinary.com/dedbfm0dk/image/upload/v1682004205/capstoneproject/pest/lifecycle/flealifecycle_ez3hua.png">
			</div>
		</div>
	</section>
	...
	<section class="section3">
		<div class="s3-div1">
			<div class="s3-d1-img">
				<img src="https://res.cloudinary.com/dedbfm0dk/image/upload/v1682004483/capstoneproject/pest/fact/fleafact_pkwpl5.jpg">
			</div>
			<div class="info">
				<div class="info-title">
					<h1>FACT</h1>
					<h2>Hút Máu</h2>
					<p> Bọ chét đực và cái đều hút máu. Sau khi giao phối con cái đẻ trứng.</p>
					<h2>Đẻ Trứng</h2>
					<p> Bọ chét trưởng thành đẻ từ 300 - 800 trứng tùy theo loài. Sau khoảng 1 tuần trứng nở ra ấu trùng.</p>
					<h2>Ấu Trùng</h2>
					<p> Ấu trùng có hình con sâu, trên thân có nhiều lông nhỏ dài. 
					Ấu trùng ăn phân của bọ chét bố mẹ, trong phân có nhiều máu khô chưa tiêu hoá và các tạp chất hữu cơ khác. 
					Sau khoảng 2 tuần, qua 2 lần lột xác, ấu trùng nhả tơ làm kén và thành nhộng. Nhộng không ăn, không hoạt động, 
					sau 1 tuần nhộng nở ra bọ chét trưởng thành.</p>
					<h2>Vòng Đời</h2>
					<p> Thời gian hoàn thành vòng đời của bọ chét ở 21 - 230C khoảng 3 - 5 tuần.</p>
				</div>
			</div>
		</div>
	</section>
	...
	<section class="session4">
		<div class="s4-div1">
			<div class="s4-d1-title"><h2>NHỮNG LOÀI ĐỘNG VẬT GÂY HẠI THƯỜNG GẶP TẠI VIỆT NAM</h2></div>
		</div>
	...
	<section class="section5">
		<div class="s5-div1">
			<div class="s5-d1-title">
				<h2><span>BẠN CẦN XỬ LÝ </span><br/>ĐÁM BỌ CHÉT ĐÓ?<br/> HÃY LIÊN HỆ CHÚNG TÔI</h2>
