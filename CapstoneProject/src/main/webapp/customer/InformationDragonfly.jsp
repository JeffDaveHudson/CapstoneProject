...
<body>
	...
	<section class="section1">
		<div class="s1-div1">
			<div class="s1-d1-img">
				<img src="https://res.cloudinary.com/dedbfm0dk/image/upload/v1681731159/capstoneproject/pest/chuonchuon_uy54qe.jpg">
			</div>
			<div class="info">
				<div class="info-title">
					<h1>CHUỒN CHUỒN</h1>
					<h5>(Tên khoa học: Odonata)</h5>
					<p> <span>Đặc điểm:</span> Chuồn chuồn dài khoảng 5-10cm. Các chi thả lỏng xuống dưới. Trên lưng có 4 cánh.
					Chuồn chuồn có hình dạng như một chiếc máy bay trực thăng, với hai đôi cánh không bao giờ gập kể cả khi chúng đang nghỉ ngơi.</p>
				</div>
			</div>
		</div>
	</section>
	...
	<section class="section2">
		<div class="s2-div1">
			<div class="info">
				<h1>VÒNG ĐỜI</h1>
				<p> Ba giai đoạn: trứng, ấu trùng và chuồn chuồn trưởng thành. 
				Trứng sau khi giao phối, chuồn chuồn cái tìm các lá cây an toàn để đẻ trứng. Nếu không tìm được, nó sẽ đẻ trứng lên cả mặt nước. 
				Ấu trùng chiếm 2/3 quãng đời của chuồn chuồn, là giai đoạn lâu nhất trong vòng đời của nó. Trưởng thành khi thời tiết trở nên 
				ấm áp hoặc vào cuối giai đoạn ấu trùng, chúng bò lên khỏi mặt nước và dán mình chặt vào thân cây và bắt đầu quá trình lột xác.</p>
			</div>
			<div class="img">
				<img src="https://res.cloudinary.com/dedbfm0dk/image/upload/v1682004814/capstoneproject/pest/lifecycle/dragonflylifecycle_p83egc.png">
			</div>
		</div>
	</section>
	...
	<section class="section3">
		<div class="s3-div1">
			<div class="s3-d1-img">
				<img src="https://res.cloudinary.com/dedbfm0dk/image/upload/v1682004917/capstoneproject/pest/fact/dragonflyfact_yvwza7.jpg">
			</div>
			<div class="info">
				<div class="info-title">
					<h1>FACT</h1>
					<h2>Đôi Cánh</h2>
					<p> Chuồn chuồn có đôi cánh không bao giờ khép lại.</p>
					<h2>Cảnh Báo</h2>
					<p> Chuồn chuồn sử dụng màu sắc của cơ thể như một dấu hiệu cảnh bảo các loài vật khác.</p>
					<h2>Vòng Đời</h2>
					<p> Chuồn chuồn dành phần lớn thời gian cuộc đời ở giai đoạn ấu trùng và sống dưới nước.</p>
				</div>
			</div>
		</div>
	</section>
	...
	<section class="section5">
		<div class="s5-div1">
			<div class="s5-d1-title">
				<h2><span>BẠN CẦN XỬ LÝ </span><br/>ĐÁM CHUỒN CHUỒN ĐÓ?<br/> HÃY LIÊN HỆ CHÚNG TÔI</h2>
