...
<body>
	...
	<section class="cm-section1">
		<div class="div1">
			<div class="img">
				<img src="https://res.cloudinary.com/dedbfm0dk/image/upload/v1682486363/capstoneproject/controldetail/pest/controldragonfly_kjukwx.jpg">
			</div>
			<div class="content">
				<h1>MỐI NGUY HẠI</h1>
				<div class="dangerous1">
					<h4>Truyền Bệnh</h4>
					<p>Chuồn chuồn là trung gian truyền nhiễm các căn bệnh nguy hiểm.</p>
				</div>
				<div class="dangerous2">
					<h4>Ảnh Hưởng Cuộc Sống</h4>
					<p>Tiếng kêu vo ve của chuồn chuồn gây ảnh hưởng đến giấc ngủ và làm chúng ta mất tập trung công việc, suy giảm chất lượng cuộc sống.</p>
				</div>
				<div class="dangerous3">
					<h4>Ô Nhiễm Nguồn Nước</h4>
					<p>Ấu trùng của chuồn chuồn thường phát triển trong môi trường nước. Điều này gây ô nhiễm đến nguồn nước sinh hoạt, từ đó kéo theo nhiều loại bệnh tật.</p>
				</div>
			</div>
		</div>
	</section>
		...
		<div class="div1">
			<div class="content">
				...
				<div class="content-detail">
					<h4>* Âm Thanh</h4>
					<p>Tiếng kêu vo ve chuồn chuồn ra từ đôi cánh là dấu hiệu dễ nhận biết nhất cho sự xâm nhập.</p>
					<h4>* Ấu Trùng</h4>
					<p>Ấu trùng chuồn chuồn như những con sâu nhỏ, dài chưa đến 30-70 mm sẽ phát triển trong ao tù nước đọng xung quanh hoặc trong nhà của bạn.</p>
					<h4>* Mùa Mưa</h4>
					<p>Chuồn chuồn thường xuất hiện khi trời sắp mưa.</p>
				</div>
			</div>
			<div class="img">
	...
	<section class="cm-section3">
		<div class="div1">
			<div class="img">
				<img src="https://res.cloudinary.com/dedbfm0dk/image/upload/v1682483688/capstoneproject/controldetail/pest/preventfrompest/preventdragonfly_zab7zf.jpg">
			</div>
			<div class="content">
				<h1>NGĂN CHẶN</h1>
				<div class="content-detail">
					<img src="https://res.cloudinary.com/dedbfm0dk/image/upload/v1682416529/capstoneproject/logo/tinylogo_sq5t6z.jpg">
					<div class="detail"><p>Hạn chế các mùi hương thu hút chuồn chuồn.</p></div>
				</div>
				<div class="content-detail">
					<img src="https://res.cloudinary.com/dedbfm0dk/image/upload/v1682416529/capstoneproject/logo/tinylogo_sq5t6z.jpg">
					<div class="detail"><p>Sử dụng mùi hương từ vỏ bưởi, húng quế, bạc hà,...để xua đuổi chuồn chuồn.</p></div>
				</div>
				<div class="content-detail">
					<img src="https://res.cloudinary.com/dedbfm0dk/image/upload/v1682416529/capstoneproject/logo/tinylogo_sq5t6z.jpg">
