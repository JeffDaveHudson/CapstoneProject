...
<body>
	...
	<section class="section1">
		<div class="s1-div1">
			<div class="s1-d1-img">
				<img src="https://res.cloudinary.com/dedbfm0dk/image/upload/v1681732232/capstoneproject/pest/mot_z6yu8r.png">
			</div>
			<div class="info">
				<div class="info-title">
					<h1>MỌT</h1>
					<h5>(Tên khoa học: Trogoderma Granarium)</h5>
					<p> <span>Đặc điểm:</span> Mọt dài 3-4mm, rộng 1-1,2mm, toàn thân màu xám đen, đầu có vòi nhô ra. 
					Trên cánh cứng có những đường dọc và nhiều điểm lõm tròn.
					Mọt hoạt bát, có tính giả chết, bay khá tốt.</p>
				</div>
			</div>
		</div>
	</section>
	...
	<section class="section2">
		<div class="s2-div1">
			<div class="info">
				<h1>VÒNG ĐỜI</h1>
				<p> Trưởng thành: dài 3-4mm, rộng 1-1,2mm, toàn thân màu xám đen, đầu có vòi nhô ra. 
				Trên cánh cứng có những đường dọc và nhiều điểm lõm tròn. 
				Trứng: dài 0,45-0,7mm, rộng 0,24-0,3mm, hình bầu dục dài, một đầu phình ra, ban đầu màu trắng sau chuyển sang màu đục nhạt.
				Sâu non: dài 2,5-3mm, đầu nhỏ màu nâu nhạt, trên mình có đường vân ngang, thân mập, ngắn, thường cong lưng, có màu vàng đục.
				Nhộng dài 3,5-4mm hình bầu dục, lúc mới hóa nhộng màu trắng sữa sau thành nâu nhạt</p>
			</div>
			<div class="img">
				<img src="https://res.cloudinary.com/dedbfm0dk/image/upload/v1682003381/capstoneproject/pest/lifecycle/woodborerlifecycle_bydmpl.png">
			</div>
		</div>
	</section>
	...
	<section class="section3">
		<div class="s3-div1">
			<div class="s3-d1-img">
				<img src="https://res.cloudinary.com/dedbfm0dk/image/upload/v1682003781/capstoneproject/pest/fact/woodborer_xktnnl.jpg">
			</div>
			<div class="info">
				<div class="info-title">
					<h1>FACT</h1>
					<h2>Phân Loại</h2>
					<p> Có thể phân loại mọt theo thức ăn của nó như mọt sách, mọt gạo, mọt ngũ cốc, mọt ngô.</p>
					<h2>Phá Hoại</h2>
					<p> Mọt là một loại côn trùng gây hại. Vì vậy, mọt có thể phá hoại trên rất nhiều loại như gỗ, lúa gạo, ngũ cốc.</p>
				</div>
			</div>
		</div>
	</section>
	...
	<section class="section5">
		<div class="s5-div1">
			<div class="s5-d1-title">
				<h2><span>BẠN CẦN XỬ LÝ </span><br/>ĐÁM MỌT ĐÓ?<br/> HÃY LIÊN HỆ CHÚNG TÔI</h2>
