...
<body>
	...
	<section class="section1">
		<div class="s1-div1">
			<div class="s1-d1-img">
				<img src="https://res.cloudinary.com/dedbfm0dk/image/upload/v1681730552/capstoneproject/pest/gian_jqs058.jpg">
			</div>
			<div class="info">
				<div class="info-title">
					<h1>GIÁN</h1>
					<h5>(Tên khoa học: Blattodea)</h5>
					<p> <span>Đặc điểm:</span> Gián là loài côn trùng có kích thước từ 3-80mm, toàn thân phủ màu nâu sáng hoặc đen. 
					Gián có tập tính ăn uống không đều, trong khi gián đực giành phần lớn thời gian đi kiếm ăn thì gián cái chỉ 
					ở yên một chỗ mà không cần ăn uống gì. Gián cái thường sản sinh 30-40 trứng mỗi 2-3 tuần, mỗi năm có thể có 
					từ 2 đến 3 mùa sinh sản.</p>
				</div>
			</div>
		</div>
	</section>
	...
	<section class="section2">
		<div class="s2-div1">
			<div class="info">
				<h1>VÒNG ĐỜI</h1>
				<p> Trải qua 3 giai đoạn đó là trứng, ấu trùng và trưởng thành.
				Tùy thuộc vào điều kiện môi trường mà trứng có thể phá vỡ để tạo thành ấu trùng. 
				Thông thường là từ 15 ngày đến 3 tháng.
				Ấu trùng sẽ có kích thước nhỏ chỉ vài mm và thiếu các bộ phận. Chúng sẽ qua nhiều lần
				lột xác để trở thành con trưởng thành.</p>
			</div>
			<div class="img">
				<img src="https://res.cloudinary.com/dedbfm0dk/image/upload/v1681984558/capstoneproject/pest/lifecycle/cockroachlifecycle_pbz9jp.png">
			</div>
		</div>
	</section>
	...
	<section class="section3">
		<div class="s3-div1">
			<div class="s3-d1-img">
				<img src="https://res.cloudinary.com/dedbfm0dk/image/upload/v1681984871/capstoneproject/pest/fact/cockroachfact_q9evhe.png">
			</div>
			<div class="info">
				<div class="info-title">
					<h1>FACT</h1>
					<h2>Phân Loại</h2>
					<p>Gián thuộc bộ nhóm sinh vật đa bào nhân chuẩn. Một số loài xâm nhập nơi ở của con người và được coi là loài gây hại.</p>
					<h2>Mầm Bệnh</h2>
					<p>Gián có thể là vật mang các bệnh khác nhau vì chúng thường được tìm thấy gần các chất thải hoặc trong nhà bếp nơi có thức ăn.</p>
					<h2>Tác Động Đến Môi Trường</h2>
					<p>Một số loài gián có lợi cho môi trường là những người tái chế quan trọng các chất hữu cơ đang thối rữa.</p>
				</div>
			</div>
		</div>
	</section>
	...
	<section class="section5">
		<div class="s5-div1">
			<div class="s5-d1-title">
				<h2><span>BẠN CẦN XỬ LÝ </span><br/>ĐÁM GIÁN ĐÓ?<br/> HÃY LIÊN HỆ CHÚNG TÔI</h2>
