...
<body>
	...
	<section class="cm-section1">
		<div class="div1">
			<div class="img">
				<img src="https://res.cloudinary.com/dedbfm0dk/image/upload/v1682486364/capstoneproject/controldetail/pest/controlcricket_l2h38x.jpg">
			</div>
			<div class="content">
				<h1>MỐI NGUY HẠI</h1>
				<div class="dangerous1">
					<h4>Phá Hại Cây Trồng</h4>
					<p>Việc dế cắn phá thân cây ớt là hiện tượng thường xuyên, khiến năng suất và sản lượng sụt giảm.</p>
				</div>
				<div class="dangerous2">
					<h4>Ảnh Hưởng Cuộc Sống</h4>
					<p>Tiếng dế nhũi hàng dêm trong phố thị gợi nhớ quê nhà, nhưng nó ám ảnh đối với những ai khó ngủ.</p>
				</div>
				<div class="dangerous3">
					<h4>Hủy Hoại Củ Quả</h4>
					<p>Con vật nhỏ bé này ăn rễ, củ, củ và cổ của thực vật.</p>
				</div>
			</div>
		</div>
	</section>
		...
		<div class="div1">
			<div class="content">
				...
				<div class="content-detail">
					<h4>* Âm Thanh</h4>
					<p>Tiếng kêu của dế dấu hiệu dễ nhận biết nhất cho sự xâm nhập của loài muỗi.</p>
					<h4>* Bằng Mắt</h4>
					<p>Dế đủ to để nhận thấy bằng mắt thường.</p>
					<h4>* Thân, Gốc Cây</h4>
					<p>Chúng là loài thích cắn phá cây ớt, cà rốt... nên có thể dễ dàng bắt gặp chúng ở đấy.</p>
				</div>
			</div>
			<div class="img">
	...
	<section class="cm-section3">
		<div class="div1">
			<div class="img">
				<img src="https://res.cloudinary.com/dedbfm0dk/image/upload/v1682484007/capstoneproject/controldetail/pest/preventfrompest/preventcricket_wmvpae.jpg">
			</div>
			<div class="content">
				<h1>NGĂN CHẶN</h1>
				<div class="content-detail">
					<img src="https://res.cloudinary.com/dedbfm0dk/image/upload/v1682416529/capstoneproject/logo/tinylogo_sq5t6z.jpg">
					<div class="detail"><p>Tìm mua và sử dụng hóa chất Regent.</p></div>
				</div>
				<div class="content-detail">
					<img src="https://res.cloudinary.com/dedbfm0dk/image/upload/v1682416529/capstoneproject/logo/tinylogo_sq5t6z.jpg">
					<div class="detail"><p>Dế không quá to nhưng có thể dễ dàng bắt bằng tay.</p></div>
				</div>
			</div>
		</div>
	</section>
