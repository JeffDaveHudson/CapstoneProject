 ...
 * 
 * @Repository public class ProductInventoryDAO {
 * 
 * @Autowired private JdbcTemplate jdbcTemplate;
 * 
 * public List<ProductInventory> getProductInventory() { String sql =
 * "SELECT * FROM productinventory"; List<ProductInventory> productInventoryList
 * = jdbcTemplate.query(sql, new RowMapper<ProductInventory>() {
 * 
 ...
 * 
 * //System.out.println("dao PInventory: "+productInventory.getId()+"-"+
 * productInventory.getQuantity()); return productInventory; } }); return
